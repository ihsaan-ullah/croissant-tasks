...
echo ""
echo "IMPORTANT: You need to start the backend server for the app to work:"
echo "  cd ~/croissant-tasks/index"
echo "  ./start.sh"
echo ""
echo "The start.sh script will automatically detect nginx and configure accordingly."
echo ""
echo "After starting, the app will be accessible at:"
echo "  http://<your-server-ip>/"
echo ""
echo "Make sure your EC2 security group allows inbound traffic on port 80 (HTTP)"
echo ""
